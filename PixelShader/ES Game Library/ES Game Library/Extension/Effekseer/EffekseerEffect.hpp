...
public:
	...
	{ SetPosition(inHandle, inRotation.x, inRotation.y, inRotation.z); }
	...
	{ SetPosition(inHandle, inScale.x, inScale.y, inScale.z); }
	inline  void SetScale(const Effekseer::Handle inHandle, const float inScale)
	{ SetPosition(inHandle, inScale, inScale, inScale); }
	...
	{ SetPosition(inHandle, inTarget.x, inTarget.y, inTarget.z); }
